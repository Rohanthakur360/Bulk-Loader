...
# Configs
API_HASH = os.environ.get('61f8a38f9d9d079100ba56fcbb9ea9b7') # Api hash
APP_ID = int(os.environ.get('26181533')) # Api id/App id
BOT_TOKEN = os.environ.get('7072770670:AAEpSfBg6P5z89aSok-E_fMKNJCjqnOdOJk') # Bot token
OWNER_ID = os.environ.get('6329158981') # Your telegram id
...
START_BUTTONS=[
    [
        InlineKeyboardButton("Source", url="Abe nalayak paid join kar lo 🥰"),
        InlineKeyboardButton("LinkTree", url="Salo paid join karna hoga😘"),
    ],
